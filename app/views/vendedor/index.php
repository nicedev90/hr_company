      ...
      <div class="rounded-2xl m-2 bg-neutralLight md:px-1 md:m-4 md:ml-0 md:h-full">
        ...
        <section id="main" class="py-1 px-2 md:py-0">
          ...
          <div class="m-2 p-2 rounded-xl w-full mx-auto space-y-3 bg-white shadow">
            <div class="grid grid-cols-1 gap-4 p-2 rounded-xl md:grid-cols-4 md:gap-8 md:mx-2">

              <div class="flex h-16 text-dark font-bold bg-neutral justify-center items-center rounded-lg border hover:bg-ctaLight hover:text-white">
              
                <a href="<?php echo URLROOT; ?>/vendedores/index" class="text-lg space-x-2">
              ...
              <div class="flex h-16 text-dark font-bold bg-neutral justify-center items-center rounded-lg border hover:bg-ctaLight hover:text-white">
                ...
                <a href="<?php echo URLROOT; ?>/vendedores/lista_clientes" class="text-lg space-x-2">
              ...
              <div class="flex h-16 text-dark font-bold bg-neutral justify-center items-center rounded-lg border hover:bg-ctaLight hover:text-white">
                ...
                <a href="<?php echo URLROOT; ?>/vendedores/lista_vacantes" class="text-lg space-x-2">
